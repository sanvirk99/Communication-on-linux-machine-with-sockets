...
//next free node should be property of the last node only in list 
struct Node_s {
...
//CREATE SEPERATE LIST OF FREE NODES AND LIST
// THIS WILL BE USED TO TRACK
// ITEMS FROM IT WILL BE REMOVED AND ADDED
// BASED ON FUCNTION CAll
List *free_list;
Node *free_node;
...
//Helper functions should not be called outside of this file
void first_time1();
void empty_list(List *newlist);
